...
public class Constant {
    ...
    public static final String WEB_DOMAIN= "http://ysy.yunwii.com";
    ...
    public static final String ALIPAY_APP_ID = "2017070407646240"; //沙箱: 正式:2017041606755749

    public static final String ALIPAY_PUBLIC_KEY = "AliPublicKey";// 沙箱:AliSandBoxPublicKey 正式:AliPublicKey
    ...
    public static final String WeChat_API_Domain = "sh.api.weixin.qq.com";//微信上海域名,可用可不用
    ...
    public static final String WeChat_WebLicenseUrl = "https://open.weixin.qq.com/connect/oauth2/authorize";

    public static final String WeChat_WebLicenseUrlByCode = "https://api.weixin.qq.com/sns/oauth2/access_token";

    public static final String WeChat_RefreshWebLicenseUrlByCode = "https://api.weixin.qq.com/sns/oauth2/refresh_token";

    public static final String WeChat_SnsApiUserInfoUrl = "https://api.weixin.qq.com/sns/userinfo";
